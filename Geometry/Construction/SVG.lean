...
namespace Geometry.Construction.SVG
...
point. `Float.toString` emits 6 decimal places by default (`240.000000`),
which clutters the output. -/
...
end Geometry.Construction.SVG

namespace Geometry.Construction

/-- Render this construction as a standalone SVG document. Wrapper so
`c.toSvg` dot-notation resolves; defers to `Geometry.Construction.SVG.render`. -/
